...
import { Cpu, RefreshCw, Search, Plus, X, CheckCircle2, Radio } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6" onClick={e => e.stopPropagation()}>
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-5 space-y-2 text-sm">
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-gray-600">Wait for first heartbeat — device status will change to <span className="font-semibold text-emerald-700">active</span>.</span>
            </div>
            <div className="flex items-start gap-2">
              ...
              <span className="text-gray-600">Assign to a site if not already done.</span>
            </div>
          </div>
