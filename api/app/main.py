...
from .routers import auth, sites, telemetry, audits, incidents, notifications, e911, actions, devices, lines, recordings, events, providers, heartbeat, hardware_models, admin, sims, jobs, webhooks, integration_webhooks, command, command_notifications, command_reports, command_vendors, command_verification, command_templates, command_contracts, command_network, command_testing, command_autonomous, command_site_import, command_device_assignment, carrier_verizon, customers, service_units, provisioning, zoho_crm, zoho_review, zoho_promote, vola, deployments, line_intelligence, subscriber_import, public, support, tmobile_callback, health, registrations, onboarding_review, calls, llm, device_health
...
app.include_router(zoho_review.router,           prefix="/api/integrations", tags=["zoho-review"])
app.include_router(zoho_promote.router,          prefix="/api/integrations", tags=["zoho-promote"])
app.include_router(command.router,              prefix="/api/command",      tags=["command"])
app.include_router(command_notifications.router, prefix="/api/command",      tags=["command"])
app.include_router(command_reports.router,       prefix="/api/command",      tags=["command"])
app.include_router(command_vendors.router,       prefix="/api/command",      tags=["command"])
app.include_router(command_verification.router,  prefix="/api/command",      tags=["command"])
app.include_router(command_templates.router,     prefix="/api/command",      tags=["command"])
