...
app.include_router(ops_center.router,         prefix="/api/ops-center",       tags=["ops-center"])
...
async def feature_flags():
    ...
    return {
        ...
        # AI Customer Operations Center / Support Center master switch.
        # When false, /api/ops-center routes 404 and the UI hides the
        # Support Center surface.  Default off.
        "ops_center": settings.FEATURE_OPS_CENTER.lower() == "true",
    }
