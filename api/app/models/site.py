...
class Site(Base):
    ...
    last_checkin: Mapped[Optional[datetime]] = mapped_column(nullable=True)
    ...
    heartbeat_next_due: Mapped[Optional[datetime]] = mapped_column(nullable=True)
    ...
    last_device_heartbeat: Mapped[Optional[datetime]] = mapped_column(nullable=True)
    last_portal_sync: Mapped[Optional[datetime]] = mapped_column(nullable=True)
